...
### 理解人类语言
 ...
 - 衡量the conceptual lables的两个指标
   - Coverage:the conceptual labels shuold cover as many words and phrases in the input as possible
   - Minimality:the number of conceptual labals should be as small as possible
 - Solution:
